...
export const MacbookScroll = ({
  ...
  return (
    <div
      ref={ref}
      className="flex min-h-[85vh] sm:min-h-[95vh] shrink-0 scale-[0.55] transform flex-col items-center justify-start py-8 sm:py-14 [perspective:800px] sm:scale-75 md:scale-100 pt-6 sm:pt-10"
    >
      {title && (
        <motion.h2
          style={{

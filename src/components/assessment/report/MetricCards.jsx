...
export function MetricCards({ displayInsurance, displayCorpus, displayMonthly }) {
  return (
    <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
      ...
      {/* Insurance Card */}
      <div className="neu-card-raised rounded-3xl p-6 flex items-start gap-4 transition-all duration-300">
        <div className="w-10 h-10 rounded-xl flex items-center justify-center shrink-0 text-[#ED8B36] neu-card-inset">
